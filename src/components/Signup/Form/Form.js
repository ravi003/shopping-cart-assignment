        ...
        <div className='row'>
          <div className='col-sm-12 col-md-12 col-lg-12 col-xs-12'>
            <div className='floating-group'>
              ...
              <Label
                for='firstname'
                className={firstname ? 'floating-label-has-text' : 'floating-label'}
              >
                First Name
              </Label>
        ...
        <div className='row'>
          <div className='col-sm-12 col-md-12 col-lg-12 col-xs-12'>
            <div className='floating-group'>
              ...
              <Label
                for='lastname'
                className={lastname ? 'floating-label-has-text' : 'floating-label'}
              >
                Last Name
              </Label>
              <span className='required-label' role='alert' aria-atomic='true'>
      ...
      <div className='row'>
        <div className='col-sm-12 col-md-12 col-lg-12 col-xs-12'>
          <div className='floating-group'>
            ...
            <Label
              for='password'
              className={password.current ? 'floating-label-has-text' : 'floating-label'}
            >
              Password
            </Label>
            <span className='required-label' role='alert' aria-atomic='true'>
        ...
        <div className='col-sm-12 col-md-12 col-lg-12 col-xs-12'>
          <div className='floating-group'>
            ...
            <Label
              ...
              className={confirmPassword ? 'floating-label-has-text' : 'floating-label'}
            >
              Confirm Password
            </Label>
            <span className='required-label' role='alert' aria-atomic='true'>
